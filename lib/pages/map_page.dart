...
class _MapPageState extends State<MapPage> {
  ...
  final Map<PlaceCategory, bool> _filters = {for (var c in PlaceCategory.values) c: true};
  ...
  List<Marker> _buildMarkers() {
              ...
              builder: (c) => Padding(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(children: [
                    ...
                    Text(p.category.label, style: const TextStyle(fontSize: 12, color: Colors.black54)),
                  ]),
                  if (p.address != null) ...[
                  ...
                  Row(children: [
                    TextButton.icon(
                      onPressed: () async {
                        ...
                        final dest = '${p.location.latitude},${p.location.longitude}';
                        final urlWeb = 'https://www.google.com/maps/dir/?api=1&origin=$origin&destination=$dest&travelmode=driving';
                        if (await canLaunchUrl(Uri.parse(urlWeb))) await launchUrl(Uri.parse(urlWeb));
                      },
    ...
    if (_currentPosition != null) {
      markers.add(Marker(
        ...
        builder: (_) => const CircleAvatar(radius: 16, child: Icon(Icons.my_location, size: 18)),
      ));
    }
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Wrap(
              ...
              children: PlaceCategory.values.map((cat) {
                ...
                return FilterChip(
                  avatar: CircleAvatar(radius: 12, backgroundColor: cat.color, child: const Icon(Icons.location_on, size: 14, color: Colors.white)),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FlutterMap(
        ...
        options: MapOptions(center: center, zoom: 13.0, minZoom: 3, maxZoom: 18),
        children: [
          TileLayer(
